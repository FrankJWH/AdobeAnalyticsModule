...
namespace Shift7Digital.Modules.Shift7AnalyticsAdobeAnalyticsModule.Data
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Shift7Digital.Modules.Shift7AnalyticsAdobeAnalyticsModule.Data.SqlDataprovider,AdobeAnalyticsModule";
